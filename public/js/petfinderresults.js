    ...
    function onGeolocateSuccess(coordinates) {
      ...
      function reverseGeocode() {
        ...
        geocoder.geocode({ 'location': latlng }, function (results, status) {
          ...
          console.log(zip)
          var queryUrl = `https://api.petfinder.com/pet.find?format=json&key=a7e12d55f8325f95f249644d6b56c772&location=${zip}&animal=dog&breed=German+Shepherd+Dog&callback=?`
          $.ajax({
            dataType: 'json',
            url: queryUrl,
            method: 'GET'
